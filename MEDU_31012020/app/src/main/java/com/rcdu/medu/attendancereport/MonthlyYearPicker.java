...
public class MonthlyYearPicker {
     ...
     */
    public MonthlyYearPicker(Activity activity) {
        this.activity = activity;
        this.view = activity.getLayoutInflater().inflate(R.layout.monthly_year_picker_view, null);
    }
    ...
    public void build(int selectedMonth, int selectedYear, DialogInterface.OnClickListener positiveButtonListener,
        ...
        builder = new AlertDialog.Builder(activity, R.style.DialogSlideAnim);
